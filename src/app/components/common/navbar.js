  ...
  return (
    <>
      <nav
        ...
        } w-full relative z-50 top-0 start-0`}
      >
        <div
            ...
            <ul
              className={`${
                isHomeActive
                  ? "bg-gray-100 dark:bg-gray-800"
                  : "bg-gray-200 dark:bg-gray-900"
              } font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700`}
            >
              <li>
                <Link
                  href="/"
              ...
              <li className="relative">
                ...
                >
                  ...
                  >
                    <li>
                      <Link
                        href="/services/1-detail#profile"
                        className="block px-4 py-2 text-nowrap hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      >
                    ...
                    <li>
                      <Link
                        href="/services/1-detail#dashboard"
                        className="block px-4 py-2 text-nowrap hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      >
                    ...
                    <li>
                      <Link
                        href="/services/1-detail#settings"
                    ...
                    <li>
                      <Link
                        href="/services/1-detail#startup"
                        className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      >
              ...
              <li className="relative">
                ...
                <div
                  id="dropdownHoverResouce"
                  className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-auto dark:bg-gray-700"
                >
                  <ul
                    className="py-2 text-sm text-gray-700 dark:text-gray-200"
                    aria-labelledby="dropdownHoverButtonResource"
                  >
                    <li>
                      <Link
