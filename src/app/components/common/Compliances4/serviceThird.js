            ...
            <div className="max-w-full mx-auto p-6">
                ...
                <section className="space-y-8">
                    ...
                    <div className="text-center mt-12">
                        <h3 className="text-xl font-semibold text-gray-800">Why Choose IGCL India?</h3>
                        <ul className="list-disc list-inside mt-4 text-gray-600 text-justify">
                    ...
                    <div className="text-center mt-12">
                        <h3 className="text-xl font-semibold text-gray-800">Get Started Today!</h3>
                        <p className="text-gray-600 mt-4">Ready to take your start-up to the next level? Contact us now to learn more about our services and how we can support your entrepreneurial journey.</p>
                    </div>
                </section>
            </div>
        </>
