          ...
          <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-6">
            <div className="">
              <div className="text-gray-500 sm:text-lg dark:text-gray-400">
                <h2 className="mb-4 text-4xl md:text-7xl font-bold mb-5 text-gray-800">
                  Maximizing Employee Rewards with the Payment of Bonus Act,
                  1965
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-1 gap-2">
                  <p className="mb-4 font-medium text-justify text-lg lg:text-xl">
                    ...
                    bonuses to employees in certain establishments, thereby
                    fostering a sense of financial security and recognition for
            ...
            <div className="rounded-lg dark:bg-gray-800">
              <ul role="list" className="space-y-4 mt-8 text-gray-500 dark:text-gray-400">
                {[
                  ...
                  "Assistance in the calculation of the accurate amount of bonus",
                  "Preparation & Submission of Annual returns as prescribed under the act",
