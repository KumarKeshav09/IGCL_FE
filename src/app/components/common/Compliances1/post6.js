            ...
            <div className="">
              <div className="text-gray-500 sm:text-lg dark:text-gray-400">
                <h2 className="mb-4 text-4xl tracking-tight md:text-7xl font-bold mb-5 text-gray-800">
                  Effortless PT and LWF Compliance Solutions!
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-1 gap-2">
                  <p className="mb-4 font-medium text-justify text-lg lg:text-xl">
                    ...
                    governments to support welfare initiatives for workers.
                    Compliance with Professional Tax and LWF regulations ensures
                    adherence to legal requirements and supports the welfare of
                    employees.
                  </p>
                </div>
              </div>
          ...
          <div className="py-4 px-4 mx-auto max-w-screen-xl lg:py-6 lg:px-6">
            ...
            <div className=" p-4  rounded-lg md:p-2 dark:bg-gray-800">
              <p className="mb-3 text-gray-500 dark:text-gray-400 text-justify text-lg lg:text-xl">
                ...
                from employers to support worker welfare initiatives, as
                required by state law. Both PT and LWF compliance are essential
                for employers and employees to fulfill statutory obligations and
                ...
                {[
                  ...
                  <li key={index} className="flex space-x-2 rtl:space-x-reverse items-start">
                    <svg
                      ...
                      viewBox="0 0 16 16" // Ensure this is the same for all SVGs
