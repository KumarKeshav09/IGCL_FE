              ...
              <div className="text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <div className="grid grid-cols-1 md:grid-cols-1 gap-2">
                  <p className="mb-4 font-medium text-justify text-lg lg:text-xl">
                    ...
                    retirement or resignation. This Act mandates the payment of
                    gratuity, a lump sum amount, to employees who have completed
                    a minimum of five years of continuous service with an
                    employer.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-lg dark:bg-gray-800">
              <ul role="list" className="space-y-4 mt-8 text-gray-500 dark:text-gray-400">
                {[
                  ...
                  "Assistance in obtaining appropriate Gratuity plans from insurance companies for meeting the liability of the employer towards payment of gratuity",
                  "Assistance in payment of contribution to the Approved Gratuity Fund",
                  "Assistance in ensuring compliance with various provisions of the act related to disclosures, notices, displays, deductions, forfeiture etc",
                  "Replying to / Satisfying Show Cause Notices issued by the Inspector / Controlling Authority",
                  "Representing the establishments in front of the Inspector / Controlling Authority"
                ].map((item, index) => (
                  <li key={index} className="flex space-x-2 rtl:space-x-reverse items-start">
                    ...
                    <span className="leading-tight text-lg lg:text-xl">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
