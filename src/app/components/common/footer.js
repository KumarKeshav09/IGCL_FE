  ...
  return (
    <footer className="footerMain w-full">
      <div className="mx-auto w-full">
        <div className="footerPart1Main grid grid-cols-1 gap-8 px-4 py-6 lg:py-8 md:grid-cols-2">
          <div className="content-center md:ml-12 lg:w-3/5">
            <a
              href=""
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-8">
            <div>
              <h2 className="mb-3 text-md font-bold text-gray-400 uppercase dark:text-white">
                LINKS
              </h2>
        ...
        <div className="px-4 py-6 dark:bg-gray-700 md:flex md:items-center md:justify-between md:mx-12">
          <span className="text-sm text-gray-800 dark:text-gray-800 sm:text-center">
            © 2024 <a href="/">IGCL</a>. All Rights Reserved.
          </span>
        </div>
      </div>
    </footer>
