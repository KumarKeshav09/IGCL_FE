              ...
              <div className="text-gray-500 sm:text-lg dark:text-gray-400">
                ...
                <div className="grid grid-cols-1 md:grid-cols-1 gap-2">
                  <p className="mb-4 font-medium text-justify text-lg lg:text-xl">
                    ...
                    working conditions, and safety, they protect the rights of
                    both employers and employees. Adherence to these compliances
                    is crucial for organizations to mitigate legal risks, uphold
                    employee welfare, and foster a productive work environment.
                  </p>
                </div>
              </div>
            </div>
