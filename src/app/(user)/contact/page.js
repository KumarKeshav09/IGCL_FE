      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-2 px-2 py-2 md:p-8">
        <div className="">
          <iframe
            ...
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3558.215543683814!2d75.68789117597113!3d26.8966536607795!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396c4be3b44bc21d%3A0x868c76019d26c676!2sVaishali%20Utsav!5e0!3m2!1sen!2sin!4v1727677114729!5m2!1sen!2sin"
            allowfullscreen=""
          ></iframe>
        </div>
            ...
            <div className="flex">
              ...
              <div className="ml-4 w-full">
                <div className="flex justify-center">
                  <h6 className="text-gray-700  ml-3 text-xl font-bold leading-5 pb-3 md:text-start text-center">
                    Registered & Corporate Office (INDIA)
                  </h6>
                </div>
                <hr />
